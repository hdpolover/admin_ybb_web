...
<body>
    ...
    </div> <!-- Delete Abstract Topic Modal -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var topicTable = $('#abstract-topics-table').DataTable({
                ...
                language: {
                    emptyTable: "No abstract topics found. Click 'Add New' to create one.",
                    zeroRecords: "No matching abstract topics found",
                    info: "Showing _START_ to _END_ of _TOTAL_ abstract topics",
                    infoEmpty: "Showing 0 to 0 of 0 abstract topics",
                    infoFiltered: "(filtered from _MAX_ total abstract topics)",
